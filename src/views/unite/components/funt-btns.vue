  ...
  <div class="header">
    ...
    <div class="title-container">
      ...
      <div class="funt-warp">
        ...
        <el-button type="primary" @click="handleExport" :disabled='this.disable?true:false'>区间导出</el-button>
        <el-button type="primary" @click="handleDelete" :disabled='this.disable?true:false'>区间删除</el-button>
...
export default {
  ...
  methods: {
     ...
     */
    handleFileChange(e) {
      this.$emit('import', { target: e.target });
    },
  ...
  mounted() {
    // this.$refs.selecTableList.setOptionsList(this.selecTableList);  // 选择列表
    // this.$refs.selecColumnList.setOptions(this.selecColumnList);  // 选择字段
    // this.$refs.selectMainColumn.setSelected('唯一标识码');  // 选择字段
  },
}
</script>
