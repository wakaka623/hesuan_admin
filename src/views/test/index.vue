<template>
  <div class="app-container">
    ...
    <div class="main">
      <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: auto" @selection-change="handleSelectionChange">
        <el-table-column type="selection" width="55"></el-table-column>
        <el-table-column v-for="(item, index) in tableHeadData" :key="index" :prop="item.COLUMN_NAME" :label="item.column_comment"></el-table-column>
...
<script>
import { getTableHeader, getTableDatas, importExcel } from '@/api/excel';
